...
;
var filter = document.querySelectorAll(".filter__item");
[].forEach.call(filter, function (e) {
  e.addEventListener("click", function () {
    var i = e.getAttribute("data-filter");

    if (i == "1") {
      [].forEach.call(document.querySelectorAll(".portfolio__column"), function (el) {
      ...
      [].forEach.call(document.querySelectorAll(".portfolio__column.f_" + i), function (el) {
        el.style.display = "block";
      });
    }
...
if (inputs) {
  [].forEach.call(inputs, function (e) {
    ...
    if (dv) {
      e.style.color = "rgba(0, 0, 0, ".concat(PLACEHOLDER_OPACITY, ")");
      e.value = dv;
    }
...
window.addEventListener("scroll", function () {
  var s = -pageYOffset / 2;
  document.querySelector(".mainblock__image").style.transform = "translate3d(0, ".concat(s, "px, 0)");
